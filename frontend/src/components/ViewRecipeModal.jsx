...
export default function ViewRecipeModal({ isOpen, onClose, recipeId }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-1xl shadow-xl max-w-2xl w-full p-6 relative">
        {/* Close Button */}
        <button
          onClick={onClose}
       ...
       {recipe.image && (
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-4">
          ...
          <p className=" list-disc list-inside text-gray-700 whitespace-pre-line">{recipe.instructions}</p>
        </div>
      </div>
    </div>
  );
