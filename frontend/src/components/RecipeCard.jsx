...
const RecipeCard = ({ recipe, pinned, togglePin, handleDelete, onEdit, onView, currentUserId }) => {
  ...
  <div className="p-4 flex flex-col flex-grow">
    ...
    {/* Action Buttons - always aligned bottom */}
    <div className="mt-auto flex gap-2">
      ...
      <button
        ...
        disabled={!isOwner}
        className="flex-1 text-center px-3 py-2 bg-black text-white rounded-lg hover:bg-yellow-600 disabled:opacity-50 transition-colors"
      >
        Edit
      </button>
      <button
        ...
        disabled={!isOwner}
        className="flex-1 text-center px-3 py-2 bg-black text-white rounded-lg hover:bg-red-600 disabled:opacity-50 transition-colors"
      >
        Delete
      </button>
    </div>
